            ...
            <div className={S.content}>
                <div className={S.withImage__top}>
                    ...
                    <div className={S.withImage_image}>
                        <img style={{position:'absolute',top:0,left:0,right:0,bottom:0,width:'100%',height:'100%'}} src={Taro1.src} alt=''/>
                    </div>
                </div>
                <div className={S.withImage__bottom}>
                    <div className={S.withImage_image}>
                        <img style={{position:'absolute',top:0,left:0,right:0,bottom:0,width:'100%',height:'100%'}} src={Taro2.src} alt=''/>
                    </div>
                    <div className={S.withImage_text}>
